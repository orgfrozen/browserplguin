const SLOT_EXECUTION_KEYS = new Set(['activeExecution', 'lastRun', 'lastRecovery', 'parkedExternalWaits', 'parkedCleanupRetries', 'schedulerTelemetry', 'agentControlTelemetry']);
